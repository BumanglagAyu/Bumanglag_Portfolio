...
const Hero = () => {
  ...
  const role = useRoleSwitcher({
    roles: ['COMPUTER SCIENCE GRADUATE', 'SOFTWARE DEVELOPER', 'FULL-STACK WEB DEVELOPER'],
  })
        ...
        <div className="flex min-h-48 flex-col justify-between lg:min-h-56 lg:max-w-[33.75rem]">
          <h1>
            <span className="text-neutral mb-2 block text-3xl font-bold">
              Hi, I'm AU P. BUMANGLAG
            </span>
            <span className="text-accent block text-[1.75rem] font-bold">{role}</span>
          </h1>

          <h2 className="text-neutral mt-3">
            I’m a Computer Science graduate with hands-on experience building full-stack web
            applications using React.js, Node.js, Express.js, and MySQL. I enjoy developing
            practical, user-friendly software solutions and continuously improving my skills in web
            development, backend systems, and databases.
          </h2>
        ...
        <div className="flex min-h-[18.75rem] items-center justify-center lg:min-h-[35rem]">
          <div className="text-accent relative size-56 sm:size-60 md:size-[20rem] lg:size-[25.75rem]">
            <Image
              ...
              alt="AU P. Bumanglag - Computer Science Graduate"
